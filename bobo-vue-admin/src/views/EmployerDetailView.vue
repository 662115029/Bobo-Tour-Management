                ...
                <div v-if="documents.length" class="grid grid-cols-5 gap-2">
                  <div v-for="d in documents" :key="d.em_doc_id"
                    ...
                    <div class="p-2 flex flex-col gap-0.5">
                      ...
                      <span class="badge self-start" :class="{ verified: d.em_doc_status === 'APPROVED', cancelled: d.em_doc_status === 'REJECTED', pending: d.em_doc_status === 'PENDING' }">{{ d.em_doc_status }}</span>
