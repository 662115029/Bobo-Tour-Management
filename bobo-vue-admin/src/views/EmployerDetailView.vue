  ...
  <div>
    ...
    <div v-else-if="em">
      ...
      <div class="hero-card">
        <div class="hero-left">
          <img
            v-if="em.em_profile_image_url"
            :src="em.em_profile_image_url"
            class="avatar"
          />
          ...
          <div>
            <span class="badge" :class="em.em_verify_status?.toLowerCase()">{{
              em.em_verify_status
            }}</span>
          ...
          <div class="doc-grid">
            <div v-for="d in documents" :key="d.em_doc_id" class="doc-card">
              ...
              <div class="doc-info">
                ...
                <a :href="d.file_url" target="_blank" class="link"
                  >View File →</a
                >
              </div>
            </div>
              ...
              <tr v-for="j in jobs" :key="j.job_id">
                ...
                <td>
                  <span
                    ...
                    :class="{
                      blue:
                        j.job_status === 'OPEN' || j.job_status === 'MATCHING',
                ...
                <td>
                  {{
                    j.job_price
                      ? "฿" + Number(j.job_price).toLocaleString()
                      : "-"
                  }}
                </td>
              </tr>
