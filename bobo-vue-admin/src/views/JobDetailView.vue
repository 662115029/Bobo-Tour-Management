  ...
  <div>
    ...
    <div v-else class="px-5 pb-8">
      ...
      <div class="flex items-center justify-between py-3 mb-5">
        ...
        <button class="btn-action delete flex items-center gap-1.5 !px-3.5 !py-2 !text-caption !rounded-lg" @click="showDeleteModal = true">
      ...
      <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm p-6 mb-4 hover:shadow-md transition-shadow">
        <div class="flex items-start justify-between gap-4 mb-5">
          <div class="flex-1 min-w-0">
            ...
            <h1 class="text-title font-bold text-[#111] leading-tight mb-1.5">{{ job.job_title }}</h1>
            <div class="flex items-center gap-1.5 text-caption text-[#666]">
            ...
            <p v-if="job.job_description" class="text-caption text-[#888] leading-relaxed mt-2 max-w-2xl">{{ job.job_description }}</p>
          </div>
          <div class="text-right shrink-0">
            <div class="text-meta text-[#bbb] uppercase tracking-wide font-medium mb-1">Price</div>
            <div class="text-title font-bold text-[#111]">{{ job.job_price ? "฿" + Number(job.job_price).toLocaleString() : "–" }}</div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-[#f0f0f0]">
          <div class="bg-[#f8f9fa] rounded-lg border border-[#eee] px-3 py-2.5 hover:border-[#ddd] hover:bg-[#f0f0f0] transition-colors">
            <div class="text-meta text-[#bbb] uppercase tracking-wide font-medium mb-0.5">Start Date</div>
            <div class="text-body font-semibold text-[#222]">{{ formatDate(job.job_start_date) }}</div>
          </div>
          <div class="bg-[#f8f9fa] rounded-lg border border-[#eee] px-3 py-2.5 hover:border-[#ddd] hover:bg-[#f0f0f0] transition-colors">
            <div class="text-meta text-[#bbb] uppercase tracking-wide font-medium mb-0.5">End Date</div>
            <div class="text-body font-semibold text-[#222]">{{ formatDate(job.job_end_date) }}</div>
          </div>
          <div class="bg-[#f8f9fa] rounded-lg border border-[#eee] px-3 py-2.5 hover:border-[#ddd] hover:bg-[#f0f0f0] transition-colors">
            <div class="text-meta text-[#bbb] uppercase tracking-wide font-medium mb-0.5">Vehicle</div>
            <div class="text-body font-semibold text-[#222]">{{ job.job_required_vehicle_type || "–" }}</div>
          </div>
          <div class="bg-[#f8f9fa] rounded-lg border border-[#eee] px-3 py-2.5 hover:border-[#ddd] hover:bg-[#f0f0f0] transition-colors">
            <div class="text-meta text-[#bbb] uppercase tracking-wide font-medium mb-0.5">Seats Required</div>
            <div class="text-body font-semibold text-[#222]">{{ job.job_required_seat || "–" }}</div>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-col gap-3">
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div class="px-4 py-4 flex flex-wrap gap-1.5">
              ...
              <span v-if="!languages.length" class="text-caption text-[#bbb]">None specified</span>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Assigned Driver</span>
            </div>
            <div class="px-4 py-4">
              <div v-if="job.selected_driver" class="flex items-center gap-2">
                ...
                <span class="text-body font-medium text-[#222]">{{ job.selected_driver }}</span>
              </div>
              <span v-else class="text-caption text-[#bbb]">Not assigned</span>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Timeline</span>
            </div>
            <div class="px-4 py-3 flex flex-col gap-3">
              <div class="flex items-center gap-2.5">
                ...
                <div><div class="text-meta text-[#bbb] uppercase tracking-wide font-medium">Created</div><div class="text-caption font-medium text-[#222]">{{ formatDateTime(job.job_created_at) }}</div></div>
              </div>
              <div class="flex items-center gap-2.5">
                ...
                <div><div class="text-meta text-[#bbb] uppercase tracking-wide font-medium">Last Updated</div><div class="text-caption font-medium text-[#222]">{{ formatDateTime(job.job_updated_at) }}</div></div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="entranceFees.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Entrance Fees</span>
            </div>
            <div class="px-4 py-4 flex flex-col gap-2">
              <div v-for="fee in entranceFees" :key="fee.job_entrance_fee_id" class="p-3 bg-[#f8f9fa] rounded-lg border border-[#e8e8e8] hover:border-[#ddd] transition-colors">
                <div class="text-caption font-semibold text-[#222] mb-2">{{ fee.place_name }}</div>
                <div class="grid grid-cols-2 gap-2">
                  <div><div class="text-meta text-[#bbb] uppercase tracking-wide font-medium">Thai</div><div class="text-caption font-semibold text-[#222]">{{ fee.thai_price > 0 ? "฿" + Number(fee.thai_price).toLocaleString() : "Free" }}</div></div>
                  <div><div class="text-meta text-[#bbb] uppercase tracking-wide font-medium">Foreigner</div><div class="text-caption font-semibold text-[#222]">{{ fee.foreigner_price > 0 ? "฿" + Number(fee.foreigner_price).toLocaleString() : "Free" }}</div></div>
                </div>
                <div v-if="fee.note" class="text-meta text-[#999] mt-1.5">{{ fee.note }}</div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="expenses.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Expenses</span>
            </div>
            <div class="px-4 py-4">
              <div class="flex flex-col divide-y divide-[#f0f0f0]">
                <div v-for="e in expenses" :key="e.job_expense_id" class="flex items-center justify-between py-2 hover:bg-[#fafafa] transition-colors px-1 rounded">
                  <span class="text-caption text-[#444]">{{ e.item_name }}</span>
                  <span class="text-caption font-semibold text-[#222]">{{ e.amount ? "฿" + Number(e.amount).toLocaleString() : "–" }}</span>
                </div>
              </div>
              <div class="flex items-center justify-between pt-3 mt-1 border-t-2 border-[#eee]">
                <span class="text-caption font-bold text-[#111]">Total</span>
                <span class="text-body font-bold text-[#111]">฿{{ Number(expenses.reduce((s, e) => s + Number(e.amount || 0), 0)).toLocaleString() }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="customers.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Customers</span>
              <span class="ml-auto inline-flex items-center justify-center bg-[#f0f4ff] text-[#3d5afe] rounded-full text-meta font-bold px-2 py-0.5">{{ customers.length }}</span>
            </div>
            <div class="px-4 py-4 flex flex-col gap-1.5">
              <div v-for="c in customers" :key="c.job_customer_id" class="flex items-center justify-between py-1.5 px-2 rounded-lg border-b border-[#f5f5f5] last:border-0 hover:bg-[#fafafa] transition-colors">
                <span class="text-caption font-medium text-[#222]">{{ c.customer_name }}</span>
                <div class="flex items-center gap-1.5">
                  <span v-if="c.pax_count" class="text-caption text-[#555] bg-[#f0f4ff] px-2 py-0.5 rounded-full">{{ c.pax_count }} pax</span>
                  <span v-if="c.note" class="text-meta text-[#aaa]">{{ c.note }}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="payments.length || paymentHistory.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Payment</span>
            </div>
            <div class="px-4 py-4 flex flex-col gap-3">
              ...
              <div v-for="pay in payments" :key="pay.payment_id" class="rounded-xl border border-[#e8e8e8] bg-[#f8f9fa] hover:border-[#ddd] hover:bg-[#f5f5f5] transition-colors overflow-hidden">
                <div class="px-4 py-3 flex items-center justify-between">
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-caption font-medium text-[#222]">{{ pay.driver_name }}</span>
                  </div>
                ...
                <div v-if="pay.paid_at || pay.confirmed_at || pay.reject_reason" class="px-4 pb-3 flex flex-col gap-1">
                  <div v-if="pay.paid_at" class="text-meta text-[#888]">Paid: {{ formatDateTime(pay.paid_at) }}</div>
                  <div v-if="pay.confirmed_at" class="text-meta text-[#888]">Confirmed: {{ formatDateTime(pay.confirmed_at) }}</div>
                  <div v-if="pay.reject_reason" class="text-meta text-red-600">Reason: {{ pay.reject_reason }}</div>
                </div>
                <div v-if="pay.slip_url" class="border-t border-[#eee]">
                  <div class="px-4 py-2 text-meta text-[#aaa] uppercase tracking-wide font-medium">Payment Slip</div>
                  <div class="h-[160px] bg-[#f0f0f0] overflow-hidden cursor-pointer hover:opacity-90 transition-opacity"
                    ...
                    <div class="hidden w-full h-full items-center justify-center flex-col gap-1.5">
                      ...
                      <span class="text-meta text-[#bbb]">Tap to view</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div v-if="paymentHistory.length">
                <button class="flex items-center gap-1.5 text-meta text-[#999] hover:text-[#555] transition-colors mt-1 mb-2"
                  ...
                  <div v-for="pay in paymentHistory" :key="pay.payment_id"
                    ...
                    <div class="px-4 py-2.5 flex items-center justify-between">
                      <div class="flex items-center gap-2">
                        ...
                        <span class="text-caption text-[#666]">{{ pay.driver_name }}</span>
                      </div>
                      <span class="payment-badge" :class="pay.payment_status?.toLowerCase()">{{ pay.payment_status }}</span>
                    </div>
                    <div class="px-4 pb-2.5 flex flex-col gap-0.5">
                      <div v-if="pay.paid_at" class="text-meta text-[#aaa]">Paid: {{ formatDateTime(pay.paid_at) }}</div>
                      <div v-if="pay.reject_reason" class="text-meta text-red-400">Reason: {{ pay.reject_reason }}</div>
                    </div>
        ...
        <div class="flex flex-col gap-3">
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="itineraries.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Itinerary</span>
            </div>
            <div class="px-4 py-4 flex flex-col gap-2">
              <div v-for="(item, i) in itineraries" :key="item.job_itinerary_id"
                ...
                <div class="w-6 h-6 rounded-full bg-[#f3e5f5] text-[#7b1fa2] text-meta font-bold flex items-center justify-center shrink-0">{{ i + 1 }}</div>
                <div class="flex-1 min-w-0">
                  <div class="text-caption font-medium text-[#222]">{{ item.place_name }}</div>
                  <div v-if="item.note" class="text-meta text-[#999] mt-0.5">{{ item.note }}</div>
                </div>
                <span class="text-caption font-bold text-[#7b1fa2] bg-[#f3e5f5] px-2 py-0.5 rounded-md whitespace-nowrap shrink-0">{{ item.start_time }} – {{ item.end_time }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="passengers.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Passengers</span>
              <span class="ml-auto inline-flex items-center justify-center bg-[#f0f4ff] text-[#3d5afe] rounded-full text-meta font-bold px-2 py-0.5">{{ passengers.length }}</span>
            </div>
            <div class="px-4 py-4 flex flex-col gap-2">
              <div v-for="(p, i) in passengers" :key="p.job_passenger_id"
                class="flex items-center gap-3 px-4 py-3 bg-[#f8f9fa] rounded-lg border border-[#e8e8e8] hover:border-[#ddd] hover:bg-[#f2f2f2] transition-colors">
                <div class="w-6 h-6 rounded-full bg-[#e8f5e9] text-[#2e7d32] text-meta font-bold flex items-center justify-center shrink-0">{{ i + 1 }}</div>
                <div class="flex-1 min-w-0">
                  <div class="text-caption font-medium text-[#222]">{{ p.first_name }} {{ p.last_name }}</div>
                  <div class="text-meta text-[#999] mt-0.5">
                ...
                <span class="text-caption font-bold text-[#1976d2] bg-[#e3f2fd] px-2 py-0.5 rounded-md whitespace-nowrap shrink-0">{{ formatPickupTime(p.pickup_time) }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="inclusions.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Inclusions</span>
            </div>
            <div class="px-4 py-4 grid grid-cols-2 gap-4">
              <div>
                <div class="flex items-center gap-1.5 text-meta font-semibold text-[#2e7d32] uppercase tracking-wide mb-2">
                ...
                <div class="flex flex-col gap-1.5">
                  <div v-for="inc in inclusions.filter(i => i.inclusion_type === 'INCLUDED')" :key="inc.job_inclusion_id"
                    class="text-caption text-[#166534] bg-[#f0fdf4] px-3 py-2 rounded-lg border border-[#bbf7d0] hover:border-[#86efac] transition-colors">{{ inc.description }}</div>
                  <div v-if="!inclusions.filter(i => i.inclusion_type === 'INCLUDED').length" class="text-caption text-[#bbb]">None</div>
                </div>
              </div>
              <div>
                <div class="flex items-center gap-1.5 text-meta font-semibold text-[#c62828] uppercase tracking-wide mb-2">
                ...
                <div class="flex flex-col gap-1.5">
                  <div v-for="inc in inclusions.filter(i => i.inclusion_type === 'NOT_INCLUDED')" :key="inc.job_inclusion_id"
                    class="text-caption text-[#991b1b] bg-[#fef2f2] px-3 py-2 rounded-lg border border-[#fecaca] hover:border-[#fca5a5] transition-colors">{{ inc.description }}</div>
                  <div v-if="!inclusions.filter(i => i.inclusion_type === 'NOT_INCLUDED').length" class="text-caption text-[#bbb]">None</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-xl border border-[#e0e0e0] shadow-sm overflow-hidden hover:shadow-md transition-shadow" v-if="applications.length">
            <div class="px-4 py-3 border-b border-[#f0f0f0] flex items-center gap-2">
              ...
              <span class="text-caption font-bold text-[#444] uppercase tracking-wide">Applications</span>
              <span class="ml-auto inline-flex items-center justify-center bg-[#f0f4ff] text-[#3d5afe] rounded-full text-meta font-bold px-2 py-0.5">{{ applications.length }}</span>
            </div>
            <div class="px-4 py-4 flex flex-col gap-2">
              <div v-for="app in applications" :key="app.job_application_id"
                ...
                <div class="flex-1 min-w-0">
                  <div class="text-caption font-medium text-[#222]">{{ app.driver_name }}</div>
                  <div class="text-meta text-[#999] mt-0.5">Applied {{ formatDateTime(app.applied_at) }}</div>
                </div>
    ...
    <div v-if="slipModal" class="modal-overlay" @click.self="slipModal = null">
      <div class="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-xl w-full mx-4 flex flex-col" style="max-height:90vh" @click.stop>
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-[#eee] shrink-0">
          <span class="text-body font-semibold text-[#111]">Payment Slip</span>
