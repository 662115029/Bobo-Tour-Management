<template>
  <div class="flex flex-col h-dvh max-w-md mx-auto bg-[#fef2f2] font-sans select-none">

    <!-- Header -->
    <div class="flex items-center gap-3 px-4 py-3 bg-[#dc2626] shadow-sm flex-shrink-0">
      <div class="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow overflow-hidden">
    ...
    <div class="flex-1 overflow-y-auto px-3 py-4 space-y-3">
      <div class="flex items-end gap-2">
        <div class="w-9 h-9 rounded-full bg-white flex items-center justify-center flex-shrink-0 shadow-sm overflow-hidden">
          <img src="@/assets/logo2.png" class="w-full h-full object-cover" />
        </div>
    ...
    <div class="flex-shrink-0 bg-white border-t border-gray-200">
      ...
      <transition name="slide-up">
        <div v-if="menuOpen" class="grid grid-rows-2 border-b border-gray-100" style="grid-template-columns: 1fr 1fr 1fr;">
          ...
          <!-- Profile -->
          <button
            class="border-r border-b border-gray-100 py-5 flex flex-col items-center gap-2 transition-colors bg-white"
            :class="user ? 'active:bg-red-50' : 'opacity-40'"
          ...
          <!-- Job — spans 2 rows -->
          <button
            class="row-span-2 py-5 flex flex-col items-center justify-center gap-2 transition-colors bg-white"
            :class="user ? 'active:bg-red-50' : 'opacity-40'"
          ...
          <button
            class="col-span-2 border-r border-gray-100 py-5 flex flex-col items-center gap-2 transition-colors bg-white"
            :class="user ? 'active:bg-red-50' : 'opacity-40'"
      ...
      <div class="flex items-center gap-2 px-3 py-2">
        ...
        <button
          ...
          :class="menuOpen ? 'bg-red-100' : 'bg-white'"
